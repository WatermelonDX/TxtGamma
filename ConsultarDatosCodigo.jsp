<html>
<head>
<title>Ingreso Datos Codigo</title>
...
<body>
<form action="IngresoDatos.jsp" method="post" name="formulario">
  <div>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>Ingrese el documento del trabajador que desea consultar </p>
<p>&nbsp; </p>
<p>Documento:
