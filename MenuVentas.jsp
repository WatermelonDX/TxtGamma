...
<div align="center">
  <table width="590" height="59" border="0">
    <tr>
      <td width="376"><div align="left"><a href="IngresoVentasCodigo.jsp">
        <button class="button3">Ingreso</button>
      </div></td>
  ...
  <table width="591" height="54" border="0">
    <tr>
      ...
      <td width="358"><div align="right">
        ...
        <a href="ModificarVentasCodigo.jsp"><button class="button3">Modificar</button></a>
      </div></td>
    </tr>
  </table>
  <table width="592" height="60" border="0">
    <tr>
      <td width="372"><div align="left"><a href="EliminarVentasCodigo.jsp">
        <button class="button3">Eliminar</button>
        </a>
      </div></td>
      <td width="204">&nbsp;</td>
    </tr> 
  ...
  <table width="594" height="60" border="0">
    <tr>
      <td width="223">&nbsp;</td>
      <td width="355"><div align="right"><a href="ConsultarVentasCodigo.jsp">
        <button class="button3">Consultar</button></a>
      </div></td>
    </tr>
  </table>
