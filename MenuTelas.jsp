...
<div align="center">
  <table width="590" height="59" border="0">
    <tr>
      <td width="376"><div align="left"><a href="IngresoTelasCodigo.jsp">
        <button class="button1">Ingreso</button>
      </a></div></td>
  ...
  <table width="591" height="54" border="0">
    <tr>
      ...
      <td width="358"><div align="right">
        <a href="modificartelascodigo.jsp">
  ...
  <table width="592" height="60" border="0">
    <tr>
      <td width="372"><div align="left"><a href="EliminarTelasCodigo.jsp">
  ...
  <table width="594" height="60" border="0">
    <tr>
      <td width="223">&nbsp;</td>
      <td width="355"><div align="right"><a href="ConsultarTelasCodigo.jsp">
        <button class="button1">Consultar</button>
      </a></div></td>
    </tr>
  </table>
