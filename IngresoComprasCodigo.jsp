      ...
      <tr>
        <td width="1218" height="205"><div>
            <blockquote>
              ...
              <p class="Estilo12">&nbsp;</p>
              <p class="Estilo7">Ingresar</p>
            </blockquote>
        </div></td>
      </tr>
    </table>
  </div> 
<form action="IngresoCompras.jsp" method="post" name="formulario">
Codigo:
<input name="codigo" type="text" id="codigo" placeholder="ingrese codigo">
<input type="submit-button" name="enviar" value="Consultar" onClick="javascript:verificar()">
</form>
