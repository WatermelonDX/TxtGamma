...
<form name="formulario" method="POST" action="ModificarTrabajadores.jsp">
<p>&nbsp;</p>
<p>&nbsp;</p>
Documento:
<input type="text" name="documento" placeholder="Ingrese documento">
<input type="submit-button" name="enviar" value="Enviar" onClick="javascript:verificar()" readOnly="true">
